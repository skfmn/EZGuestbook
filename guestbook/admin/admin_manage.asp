...
<%
    ...
    If Trim(Request.Form("chypwd")) = "yes" Then
        ...
        Set rsCommon = Server.CreateObject("ADODB.Recordset")
        strSQL = "SELECT * FROM "&msdbprefix&"admin WHERE adminID = "&Request.Cookies("EZGBAdmin")("adminID")
        ...
        If NOT rsCommon.EOF Then
	        ...
	        strSQL = "UPDATE "&msdbprefix&"admin Set salt = '"&strSalt&"', pwd = '"&strEncrPassword&"', name='"&strAdminName&"' WHERE adminID = "&Request.Cookies("EZGBAdmin")("adminID")
	        Call getExecuteQuery(strSQL)

            Response.Cookies("EZGBAdmin")("name") = strAdminName
                ...
                <div class="row uniform">
                    <div class="12u$">
                        ...
                        <div class="12u$" style="padding-bottom: 10px;">
                            ...
                            <input type="text" id="cname" name="cname" value="<%= Request.Cookies("EZGBAdmin")("name") %>" required />
                        </div>
                        <div class="12u$" style="padding-bottom: 10px;">
